    ...
    l.widget("ui.tabs", {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          ...
          this.anchors.each(function (t, e) {
            ...
            o._isLocal(e)
              ...
              : ((s = h.attr("aria-controls") || l({}).uniqueId()[0].id),
      ...
      _eventHandler: function (t) {
        var e = this.options,
          ...
          i = { oldTab: i, oldPanel: r, newTab: n ? l() : a, newPanel: h };
        t.preventDefault(),
      ...
      _getIndex: function (t) {
        return (t =
          "string" == typeof t
            ? this.anchors.index(
                this.anchors.filter("[href$='" + l.escapeSelector(t) + "']")
              )
            : t);
      },
      _destroy: function () {
      ...
      load: function (t, a) {
        ...
        var n = this,
          ...
          r = { tab: i, panel: h };
        this._isLocal(t[0]) ||
          ((this.xhr = l.ajax(this._ajaxSettings(t, a, r))),
          this.xhr &&
